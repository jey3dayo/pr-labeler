...
export declare function determineLanguage(config: Config): LanguageCode;
export declare function initializeI18n(config: Config): Result<void, ConfigurationError>;
