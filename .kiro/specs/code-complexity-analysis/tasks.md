...
- [ ] 2. 複雑度計算の基盤機能を実装
- [ ] 2.1 ComplexityAnalyzerクラスの基本構造を作成
...
- [ ] 10. テストの実装
- [ ] 10.1 ComplexityAnalyzerのユニットテスト
...
- [ ] TypeScript型チェックが通る（pnpm type-check）
- [ ] ESLintが通る（pnpm lint）
- [ ] 関連するテストが通る（pnpm test）
- [ ] 新規追加機能のテストを実装済み
- [ ] エラーハンドリングがResult型を使用している
- [ ] ログ出力が適切に実装されている
